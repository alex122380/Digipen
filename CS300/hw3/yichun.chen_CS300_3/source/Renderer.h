...
class Renderer
{
  public:
    ...
    void SetFrameBuffer(FRAME_BUFFER type);
  ...
  private:
    ...
    GLuint FBOId_;
    GLuint RBOId_;
    GLuint cubeTextureTop;
    GLuint cubeTextureBottom;
    GLuint cubeTextureRight;
    GLuint cubeTextureLeft;
    GLuint cubeTextureFront;
    GLuint cubeTextureBack;
    GLenum drawBuffers_[7] = { 
