...
ImGuiManager::ImGuiManager(GLFWwindow* window) : normalDisplay(0), currentModel(0), currentShader(0)
{
...
void ImGuiManager::Update()
{
  ...
  ImGui::RadioButton("Diffuse", &currentShader, 0); ImGui::SameLine();
  ImGui::RadioButton("Phone Lighting", &currentShader, 1); ImGui::SameLine();
  ImGui::RadioButton("Phone Shading", &currentShader, 2); ImGui::SameLine();
  ImGui::RadioButton("Blinn Shading", &currentShader, 3);
  ImGui::End();
...
int ImGuiManager::GetCurrentShader()
{
